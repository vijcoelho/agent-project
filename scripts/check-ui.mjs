...
try {
  ...
  // As cinco abas dos ajustes existem e trocam de conteúdo.
  for (const aba of ['Marketplace', 'Skills', 'Receitas', 'Media']) await page.getByRole('tab', { name: aba }).click();
  ...
  console.log('PASS: welcome, navigation, search, terminal layouts, modals, maestro selection, closing project with delayed tree response, disconnection, mobile; no page errors.');
