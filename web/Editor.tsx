  ...
  useEffect(() => {
    ...
    const state = EditorState.create({
      ...
      extensions: [
        ...
        oneDark,
        EditorView.theme({
          "&": { height: "100%", fontSize: "13px", background: "#141414", color: "#e5e5e5" },
          ...
          ".cm-activeLineGutter": { background: "#ffffff08", color: "#b8b8b8" },
          "&.cm-focused .cm-selectionBackground, .cm-selectionBackground": { background: "#ffffff25 !important" },
